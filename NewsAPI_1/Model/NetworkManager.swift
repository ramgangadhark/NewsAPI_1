...
//        }
    ...
    func APICall(url:String,completion:@escaping(NSArray?,Error?) -> Void){
        //let urlString = "\(Constants.news_API)category=\( Constants.category["technology"]!)&apiKey=\(Constants.news_API_Key)"
